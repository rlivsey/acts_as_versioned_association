## note this is pretty much identical to the acts_as_versioned tests
## running these to make sure that the modifications don't mess with
## the functionality of the original plugin!
#
